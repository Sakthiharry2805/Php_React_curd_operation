...
class Adduser extends React.Component{
    ...
    onChangeAddress(e) {
      ...
      onSubmit(e) {
        ...
        axios.post('http://localhost:1001/customer/add.php', userObject,{
            headers: {
        ...
        this.setState({ customer_name: '', customer_email: '', customer_age: '' , customer_address:'', customer_gender:'', customer_dob:''})
